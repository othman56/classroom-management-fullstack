...
const mockSubjects: Subject[] = [
  {
    ...
    code: "CS101",
    description: "A foundational course covering programming concepts and problem-solving.",
  ...
  },
  {
    ...
    code: "CS201",
    description: "Explores core data structures, algorithms, and algorithmic analysis.",
    department: "Computer Science",
